...
```{r ID, fig.cap="Die Mitglieder der AG Didaktik. Es fehlt Thomas Janßen.", echo = FALSE}
knitr::include_graphics('bild_ag.jpg')
```
...
Ein Ausdruck der Zusammenarbeit zwischen den Mathematikdidaktik-AGs in den Fachbereichen 3 und 12 ist das *Matelier*, das seit 2011 gemeinsam betrieben wird. Es befindet sich im Raum MZH 2495 und beherbergt eine reiche Sammlung an didaktischen Materialien. Neben nahezu allen gängigen Schulbüchern werden vor allem Spiele und Bastelmaterial sowie grafische und mechanische Hilfsmittel in Vitrinen dargestellt, die als Inspiration für einen aktiven Zugang zur Mathematik dienen können. Viele Materialien können von den Studierenden der Universität zudem ausgeliehen werden, sei es zur Verwendung im Schulpraktikum oder in einer unserer Lehrveranstaltungen.

Die aktuellen Öffnungszeiten des Mateliers sind (Stand Oktober 2023, für Aktualisierungen und Ausnahmen siehe [https://www.uni-bremen.de/matelier](https://www.uni-bremen.de/matelier)):
...
Außerdem ist das Matelier auch ein Tor zur Mathematik für viele Schüler\_innen, die die Universität besuchen, sei es im Rahmen der regelmäßigen *Forschertage* oder der jährlich stattfindenden *Kinder-Uni*. Dabei gibt es auch immer wieder Gelegenheit für Studierende, sich aktiv an Planung und Durchführung zu beteiligen.

Nähere Informationen finden Sie unter [https://www.uni-bremen.de/matelier](https://www.uni-bremen.de/matelier).

Das mathematikdidaktische Kolloquium
------------------------------------

Zwei bis drei mal im Semester findet im Rahmen des mathematischen Kolloquiums ein mathematikdidaktischer Vortrag eines interessanten Gasts von außerhalb statt. Auf diese Vorträge und ähnliche besondere Events wird auf der [Homepage der AG Didaktik](http://www.math.uni-bremen.de/didaktik/) hingewiesen.
