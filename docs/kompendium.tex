...
\addcontentsline{toc}{subsection}{Monographie (ein durchgehendes Werk, im Gegensatz zum Sammelband) mit einem Autor/einer Autorin}

\hangpara{0.5in}{1}Rijkaard, T. (1998). \emph{Vom Entstehen einer Sprache} (3. Aufl.). Berlin: Hauser.
...
\hangpara{0.5in}{1}Simonsen, J., Roth, D. A. \& Zahl, U. (2001). \emph{The teacher and his
...
\hangpara{0.5in}{1}Oguz, A., Penrose, D., Sievers, T., Nothman, J, Larouche, P., Michel, A., \ldots{} Peters, T. (2001). \emph{Teamwork}. Karlsruhe: Dannemann.
...
\hangpara{0.5in}{1}Othendorf, D. (Hrsg.). (1954). \emph{Neue Wege zur Mathematik: Ein Überblick}. Leipzig: Siebald.
...
\addcontentsline{toc}{subsection}{Beitrag in einem Sammel- oder Tagungsband}

\hangpara{0.5in}{1}Klose, H. (1954). Lernen durch Nachahmen. In D. Othendorf (Hrsg.), \emph{Neue
...
\begin{description}
\item[GDM]
In der \emph{Gesellschaft für Didaktik der Mathematik} (GDM) organisieren
...
Daher können die \emph{Beiträge zum Mathematikunterricht} (BzMU), in denen
...
unter \url{https://www.mathematik.tu-dortmund.de/ieem/cms/de/forschung/bzmu.html}.

Zudem ist die GDM dabei, mit der \href{https://madipedia.de}{Madipedia} ein
...
der \emph{European Society for Research in Mathematics Education} (ERME)
...
der \emph{International Commission on Mathematical Instruction} (ICMI)
organisiert.\footnote{Zusätzlich gibt es freilich auch in anderen Regionen der Welt
  ...
  ist insbesondere die \emph{Gesellschaft für empirsiche Bildungsforschung}
...
\section{Zeitschriften}\label{zeitschriften}}
